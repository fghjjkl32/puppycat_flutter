...
class _SettingService implements SettingService {
  ...
  @override
  Future<SettingResponseModel?> getSetting(int memberIdx) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>?>(
        _setStreamType<SettingResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = _result.data == null
        ? null
        : SettingResponseModel.fromJson(_result.data!);
    return value;
  }

  @override
  Future<ResponseModel?> putSetting(Map<String, dynamic> body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
