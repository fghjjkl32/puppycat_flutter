...
part of 'keep_contents_service.dart';
...
class _KeepContentsService implements KeepContentsService {
  _KeepContentsService(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<ResponseModel?> deleteKeepContents(
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/contents/keep?memberIdx=${memberIdx}&${idx}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  @override
  Future<ResponseModel?> postKeepContents(Map<String, dynamic> body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
