...
//
// part 'dog_breed_search_state_provider.g.dart';
//
// @Riverpod(keepAlive: true)
// class DogBreedSearchState extends _$DogBreedSearchState {
...
//     try {
//       var searchResult = await CreateMyPetRepository(dio: ref.read(dioProvider)).getBreedList(loginMemberIdx: _loginMemberIdx, page: pageKey, searchWord: _searchWord, limit: 20, type: 1);
//
