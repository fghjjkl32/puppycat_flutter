...
part 'my_contents_state_provider.g.dart';

final myContentsFeedListEmptyProvider = StateProvider<bool>((ref) => true);
final myContentsFeedTotalCountProvider = StateProvider<int>((ref) => 0);

@Riverpod(keepAlive: true)
class MyContentsState extends _$MyContentsState {
  int _lastPage = 0;
  ...
  Future<void> _fetchPage(int pageKey) async {
    try {
      ...
      ref.read(myContentsFeedListEmptyProvider.notifier).state = feedList.isEmpty;
