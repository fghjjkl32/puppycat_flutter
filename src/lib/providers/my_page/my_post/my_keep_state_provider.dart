...
class MyKeepStateNotifier extends StateNotifier<MyPostState> {
  MyKeepStateNotifier() : super(MyPostState());
  ...
  loadMorePost(memberIdx) async {
    ...
    final lists = await KeepContentsRepository()
        .getKeepContents(memberIdx: memberIdx, page: state.page + 1);
...
final myKeepStateProvider =
    StateNotifierProvider<MyKeepStateNotifier, MyPostState>(
  (ref) => MyKeepStateNotifier(),
);
