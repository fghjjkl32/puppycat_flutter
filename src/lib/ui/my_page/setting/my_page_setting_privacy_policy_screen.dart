...
class MyPageSettingPrivacyPolicyScreen extends ConsumerStatefulWidget {
  const MyPageSettingPrivacyPolicyScreen({super.key});

  @override
  MyPageSettingPrivacyPolicyScreenState createState() =>
      MyPageSettingPrivacyPolicyScreenState();
}

class MyPageSettingPrivacyPolicyScreenState
    extends ConsumerState<MyPageSettingPrivacyPolicyScreen> {
