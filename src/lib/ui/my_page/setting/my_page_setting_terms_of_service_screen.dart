...
class MyPageSettingTermsOfServiceScreen extends ConsumerStatefulWidget {
  const MyPageSettingTermsOfServiceScreen({super.key});

  @override
  MyPageSettingTermsOfServiceScreenState createState() =>
      MyPageSettingTermsOfServiceScreenState();
}

class MyPageSettingTermsOfServiceScreenState
    extends ConsumerState<MyPageSettingTermsOfServiceScreen> {
                  ...
                  child: Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        items: <String>[
                          '현행 시행 일자 : 2023년 05월 30일',
                          '현행 시행 일자 : 2023년 04월 30일',
                          '현행 시행 일자 : 2023년 03월 30일',
                          '현행 시행 일자 : 2023년 02월 30일'
...
''',
                    styleSheet: MarkdownStyleSheet(
                      h1: kTitle20BoldStyle.copyWith(color: kTextSubTitleColor),
                      h1Align: WrapAlignment.center,
                      h2: kTitle20BoldStyle.copyWith(color: kTextSubTitleColor),
                      h2Padding: const EdgeInsets.symmetric(
                        vertical: 10,
                      ),
                      h3: kTitle18BoldStyle.copyWith(color: kTextSubTitleColor),
                      h3Padding: const EdgeInsets.symmetric(
                        vertical: 10,
                      ),
                      h4: kBody16BoldStyle.copyWith(color: kTextSubTitleColor),
                      p: kBody13BoldStyle.copyWith(color: kTextSubTitleColor),
