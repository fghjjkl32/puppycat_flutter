...
class _KpostalViewState extends State<KpostalView> {
  ...
  Widget _buildWebView() {
    String _initialUrl = widget.useLocalServer ? 'http://localhost:${widget.localPort}/assets/web/kakao_postcode.html' : 'https://tykann.github.io/kpostal/assets/kakao_postcode.html';
