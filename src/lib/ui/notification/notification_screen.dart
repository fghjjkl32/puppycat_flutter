...
class NotificationScreenState extends ConsumerState<NotificationScreen>
  ...
  late PagingController<int, NotificationListItemModel>
      _notiListPagingController;
              ...
              Padding(
                ...
                child: Align(
                  ...
                  child: GroupButton<NotificationType>(
                    ...
                    onSelected: (type, index, isSelected) => ref
                        .read(notificationListStateProvider.notifier)
                      ...
                      return Container(
                        ...
                        child: Text(
                          ...
                          style: kButton14BoldStyle.copyWith(
                            color:
                                selected ? kTextTitleColor : kNeutralColor500,
                          ),
                        ),
                      );
                    },
                      ...
                      child: PagedListView<int, NotificationListItemModel>(
                        ...
                        builderDelegate: PagedChildBuilderDelegate<
                          ...
                          itemBuilder: (context, item, index) {
                            if (item.subType ==
                                describeEnum(NotiSubType.follow)) {
                              return NotificationFollowItem(
                                name: item.senderInfo?.first.nick ?? 'unknown',
                                regDate: item.regDate,
                                isRead: item.isShow == 1 ? true : false,
                                profileImgUrl:
                                    (item.senderInfo?.isNotEmpty ?? false)
                                        ? item.senderInfo!.first.profileImgUrl
                                        : '',
                                isFollowed:
                                    item.followState == 1 ? true : false,
                                onTapFollowButton: (isFollowed) {
                                  var loginMemberIdx =
                                      ref.read(userInfoProvider).userModel!.idx;
                                  if (isFollowed) {
                                    ref
                                        .read(notificationListStateProvider
                                            .notifier)
                                        .unSetFollow(
                                            loginMemberIdx, item.senderIdx);
                                  } else {
                                    ref
                                        .read(notificationListStateProvider
                                            .notifier)
                                    ...
                                    describeEnum(NotiSubType.new_contents) ||
                                item.subType ==
                                    describeEnum(
                                        NotiSubType.mention_contents) ||
                                item.subType ==
                                    describeEnum(NotiSubType.img_tag) ||
                                item.subType ==
                                    describeEnum(NotiSubType.like_contents)) {
                              return NotificationPostItem(
                                ...
                                imgUrl: item.img ?? '',
                                isLiked:
                                    item.contentsLikeState == 1 ? true : false,
                                onTap: () {
                                  ///TODO
                                  ///route 정리 필요
                                  var loginMemberIdx =
                                      ref.read(userInfoProvider).userModel!.idx;
                                  context.push(
                                      "/home/myPage/detail/testaaa/게시물/$loginMemberIdx/${item.contentsIdx}/notificationContent");
                                },
                                onLikeTap: (isLiked) {
                                  var loginMemberIdx =
                                      ref.read(userInfoProvider).userModel!.idx;
                                  if (isLiked) {
                                    ref
                                        .read(notificationListStateProvider
                                            .notifier)
                                        .unSetFeedLike(
                                            loginMemberIdx, item.contentsIdx);
                                  } else {
                                    ref
                                        .read(notificationListStateProvider
                                            .notifier)
                                ...
                                onCommentTap: () {
                                  ...
                                  var loginMemberIdx =
                                      ref.read(userInfoProvider).userModel!.idx;
                                  context.push(
                                      "/home/myPage/detail/nickname/게시물/$loginMemberIdx/${item.contentsIdx}/notificationContent",
                                      extra: {
                                        "isRouteComment": true,
                                      });
                                },
                                    ...
                                    describeEnum(NotiSubType.new_comment) ||
                                item.subType ==
                                    describeEnum(NotiSubType.new_reply) ||
                                item.subType ==
                                    describeEnum(NotiSubType.mention_comment) ||
                                item.subType ==
                                    describeEnum(NotiSubType.like_comment)) {
                              return NotificationCommentItem(
                                ...
                                mentionList:
                                    (item.mentionMemberInfo?.isNotEmpty ??
                                            false)
                                        ? item.mentionMemberInfo!.first
                                        : {},
                                profileImgUrl:
                                    (item.senderInfo?.isNotEmpty ?? false)
                                        ? item.senderInfo!.first.profileImgUrl
                                ...
                                onTab: () {
                                  print(
                                      'item.commentIdx ${item.commentIdx} / ${item.contentsIdx}');
                                  var loginMemberIdx =
                                      ref.read(userInfoProvider).userModel!.idx;
                                  context.push(
                                      "/home/myPage/detail/nickname/게시물/$loginMemberIdx/${item.contentsIdx}/notificationContent",
                            ...
                            // }
                                ...
                                describeEnum(NotiSubType.notice)) {
                              return NotificationNoticeItem(
                                ...
                                describeEnum(NotiSubType.event)) {
                              return NotificationNoticeItem(
                                content: item.body,
                                regDate: item.regDate,
                                isRead: item.isShow == 1 ? true : false,
