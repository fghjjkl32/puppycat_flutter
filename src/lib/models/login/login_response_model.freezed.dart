...
abstract class $LoginResponseModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool result, String code, String message});
}
...
class _$_LoginResponseModel implements _LoginResponseModel {
  _$_LoginResponseModel(
      {required this.result, required this.code, required this.message});
  ...
  @override
  String toString() {
    return 'LoginResponseModel(result: $result, code: $code, message: $message)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, result, code, message);
...
abstract class _LoginResponseModel implements LoginResponseModel {
  factory _LoginResponseModel(
      ...
      required final String message}) = _$_LoginResponseModel;
