...
import 'package:pet_mobile_social_flutter/models/main/user_list/user_list_data.dart';
...
class PopularUserListDataListModel with _$PopularUserListDataListModel {
  ...
  factory PopularUserListDataListModel.fromJson(Map<String, dynamic> json) =>
      _$PopularUserListDataListModelFromJson(json);
}
