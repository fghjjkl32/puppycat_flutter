...
class FeedBestPostWidget extends StatelessWidget {
  const FeedBestPostWidget({Key? key, required this.feedData})
      : super(key: key);
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return GestureDetector(
                  onTap: () {
                    context.push(
                        "/home/myPage/detail/${feedData[index].memberInfoList![0].nick}/게시물/${feedData[index].memberInfoList![0].memberIdx}/${feedData[index].idx}/userContent");
                  },
