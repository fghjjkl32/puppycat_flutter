...
abstract class AssetPickerBuilderDelegate<Asset, Path> {
  ...
  /// 根据主题返回状态栏的明暗样式
  SystemUiOverlayStyle get overlayStyle => theme.appBarTheme.systemOverlayStyle ?? (theme.effectiveBrightness.isDark ? SystemUiOverlayStyle.light : SystemUiOverlayStyle.dark);
                  ...
                  if (index == 0) {
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Image.asset(
                            'assets/image/feed/icon/small_size/icon_camera.png',
                            height: 18.h,
                          ),
                        ),
                      ),
